...
if "Jacob" in name:
    print("Jacob was found in name")
else:
    print("Jacob was not found in name")

# 2) Test to see if the string "Michael" is in name, print the result
if "Michael" in name:
    print("Michael was found in name")
else:
    print("Michael was not found in name")
...
if name.islower():
    print("Name contains only lowercase")
else:
    print("Name does not contain only lowercase")

...
birthdays['Dan'] = 'May 29'
birthdays['Heather'] = 'October 5'
birthdays['Allison'] = 'July 12'
...
for k in miles_ridden:
    print(k, miles_ridden[k])
...
if 'Mon' in days:
    print("Mon was found in the days set")
else:
    print("Mon was not found in the days set")
